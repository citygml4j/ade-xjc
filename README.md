...
Note that versions of the software before 2.3.0 continue to be licensed under GNU LGPL 3.0 license. To request a previous of ade-xjc under Apache 2.0 create a GitHub issue.
